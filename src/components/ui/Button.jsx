...
const Button = ({ children, variant = 'primary', size = 'md', className = '', onClick, ...props }) => {
  ...
  const variants = {
    ...
    secondary: "bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 hover:border-zinc-300 dark:hover:border-zinc-650 hover:bg-zinc-50 dark:hover:bg-zinc-750 shadow-sm hover:-translate-y-0.5",
