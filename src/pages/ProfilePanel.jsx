  ...
  return (
    <div className="min-h-screen pt-32 px-6 lg:px-8 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white pb-20 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        {isEditing ? (
          <div className="bg-white dark:bg-zinc-50 p-10 rounded-[3rem] shadow-sm border border-zinc-100 dark:border-zinc-200 flex flex-col md:flex-row gap-10 mb-12 relative overflow-hidden w-full">
            ...
            <div className="flex flex-col items-center gap-4 flex-shrink-0 z-10">
              <div className="w-40 h-40 bg-zinc-50 dark:bg-zinc-150 rounded-[2.5rem] border-[6px] border-white dark:border-zinc-200 shadow-xl overflow-hidden flex-shrink-0 flex items-center justify-center relative">
            ...
            <div className="flex-grow space-y-6 z-10 w-full">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-5 py-3.5 rounded-2xl border-2 border-zinc-200 dark:border-zinc-200 bg-white dark:bg-zinc-150 text-zinc-900 dark:text-white focus:border-blue-500 focus:outline-none font-medium transition-colors text-base"
                />
              </div>

              <div>
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-350 mb-2">Semilla de Avatar (Escribe palabras para cambiarlo)</label>
                <input 
                  type="text" 
                  value={avatarSeed} 
              ...
              <div>
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-350 mb-2">Color de Fondo</label>
                <div className="flex gap-3 mt-1">
                  {PRESET_BG.map(bg => (
                    <button 
                      key={bg.value} 
                      onClick={() => setAvatarBg(bg.value)}
                      className={`w-10 h-10 rounded-full border-2 transition-all ${bg.color} ${avatarBg === bg.value ? 'border-zinc-800 scale-110 shadow-md' : 'border-white dark:border-zinc-200 hover:scale-105'}`}
                      title={bg.label}
                    />
                  ))}
                </div>
          ...
          <div className="bg-white dark:bg-zinc-50 p-10 rounded-[3rem] shadow-sm border border-zinc-100 dark:border-zinc-200 flex flex-col md:flex-row items-center gap-10 mb-12 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-bl from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 rounded-full blur-[80px] -z-0 pointer-events-none"></div>
            <div className="relative z-10 w-40 h-40 bg-orange-100 dark:bg-zinc-150 rounded-[2.5rem] border-[6px] border-white dark:border-zinc-200 shadow-xl overflow-hidden flex-shrink-0 rotate-3">
            ...
            <div className="relative z-10 flex-grow text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-6">
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-100 dark:bg-yellow-950/30 text-yellow-600 dark:text-yellow-400 font-bold text-sm border border-yellow-200 dark:border-yellow-900/30"><Trophy size={18}/> Nivel {user.level}</span>
              ...
              <div className="w-full bg-zinc-100 dark:bg-zinc-150 rounded-full h-3 mb-3 shadow-inner">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
          ...
          <div className="bg-zinc-100 dark:bg-zinc-50 p-8 rounded-[2rem] flex flex-col items-center justify-center text-center border-2 border-zinc-200 dark:border-zinc-200 border-dashed opacity-60">
